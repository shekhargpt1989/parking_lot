...
/**'
 * CreateReqValidationStrategyTest.
 */
public class CreateReqValidationStrategyTest {

  private ValidationStrategy validationStrategy = new CreateReqValidationStrategy(1);
